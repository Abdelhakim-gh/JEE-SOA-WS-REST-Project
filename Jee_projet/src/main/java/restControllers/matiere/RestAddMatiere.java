...
/**
 * Servlet implementation class RestAddMatiere
 */
@WebServlet("/RestAddMatiere")
public class RestAddMatiere extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RestAddMatiere() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String apiUrl = "http://localhost:8083/SOA_Project/Matieres/add?id_matiere=" + idMatiere 
                        + "&label=" + label + "&prix=" + prix + "&section_id=" + sectionId;
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                out.println("<h3>Failed to add matiere!</h3>");
            }
        } catch (IOException e) {
            // Handle exception
            e.printStackTrace();
