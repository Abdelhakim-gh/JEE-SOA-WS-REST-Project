...
public class ClasseDAO {
	...
	public int addClasse(int id_classe, String label, int id_section) {
...
//		
		String sql;
		if (id_classe != 0) {
			sql = "insert into classes(id_classe, label, section_id) values(" + id_classe + " , '"+label+"', "+id_section+");";
		} else {
			sql = "insert into classes(label, section_id) values('"+label+"', "+id_section+");";
		}
