...
public class MatiereDAO {
	...
	public int addMatiere(int id_matiere, String label, int id_section, float prix) {
...
//		}
		...
		String sql;
		if (id_matiere != 0) {
			sql = "insert into matieres(id_matiere, label, section_id, prix) values(" + id_matiere + " , '"+label+"', "+id_section+", "+prix+");";
		} else {
			sql = "insert into matieres(label, section_id, prix) values('"+label+"', "+id_section+", "+prix+");";
		}
