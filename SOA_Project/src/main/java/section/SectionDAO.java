...
public class SectionDAO {
	...
	public int addSection(int id_section, String niveau, String filiere) {
		...
		String sql;
		if (id_section != 0) {
			sql = "insert into sections(id_section, niveau, filiere, label) values(" + id_section + ", '"+niveau+"', '"+filiere+"', DEFAULT);";
		} else {
			sql = "insert into sections(niveau, filiere, label) values('"+niveau+"', '"+filiere+"', DEFAULT);";
		}
